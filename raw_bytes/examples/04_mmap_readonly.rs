...
fn create_sample_data(path: &Path) -> std::io::Result<()> {
    let records = vec![
        Record { timestamp: 1000, sensor_id: 1, value: 23.5 },
        Record { timestamp: 2000, sensor_id: 1, value: 24.1 },
        Record { timestamp: 3000, sensor_id: 2, value: 18.7 },
        Record { timestamp: 4000, sensor_id: 2, value: 19.2 },
        Record { timestamp: 5000, sensor_id: 3, value: 21.0 },
    ];
